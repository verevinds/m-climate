    ...
    <section className={styles['tabs']}>
      ...
      {description && isDescription ? (
        ...
        <div className={styles['content']}>
          ...
          {servicedArea && (
            <div className={styles['line']}>
              <span className={styles['name']}>Обслуживаемая площадь</span>
              <span className={styles['dots']} />
          ...
          {powerCooling && (
            <div className={styles['line']}>
              <span className={styles['name']}>Мощность (охлаждение)</span>
              <span className={styles['dots']} />
          ...
          {powerHeating && (
            <div className={styles['line']}>
              <span className={styles['name']}>Мощность (обогрев)</span>
              <span className={styles['dots']} />
          ...
          {energyEfficiency && (
            <div className={styles['line']}>
              <span className={styles['name']}>Класс энергоэффективности</span>
              <span className={styles['dots']} />
          ...
          {noiseInside && (
            <div className={styles['line']}>
              <span className={styles['name']}>Уровень шума (внутри)</span>
              <span className={styles['dots']} />
          ...
          {noiseOutside && (
            <div className={styles['line']}>
              <span className={styles['name']}>Уровень шума (снаружи)</span>
              <span className={styles['dots']} />
          ...
          {sizeIndoor && (
            <div className={styles['line']}>
              <span className={styles['name']}>Размер (Внутренний блок)</span>
              <span className={styles['dots']} />
          ...
          {sizeOutdoor && (
            <div className={styles['line']}>
              <span className={styles['name']}>Размер (Наружный блок)</span>
              <span className={styles['dots']} />
          ...
          {weightIndoor && (
            <div className={styles['line']}>
              <span className={styles['name']}>Вес (Внутренний блок)</span>
              <span className={styles['dots']} />
          ...
          {weightOutdoor && (
            <div className={styles['line']}>
              <span className={styles['name']}>Вес (Наружный блок)</span>
              <span className={styles['dots']} />
          ...
          {warranty && (
            <div className={styles['line']}>
              <span className={styles['name']}>Гарантия</span>
              <span className={styles['dots']} />
